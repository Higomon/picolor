...
| 色基準 | [色基準チャート（Spyder Checkr 48色モデル）](https://www.datacolor.jp/camera-solution/spyder-checkr.html)、[18%グレーカード（銀一シルクグレーカードVer.2）](https://www.ginichi.com/shop/g/g13819/) | グレーカードはA4判2枚入り。表面の反射率18%側を使用 |
